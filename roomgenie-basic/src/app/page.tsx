...
const GALLERY = [
  { img: 'https://images.unsplash.com/photo-1618219908412-a29a1bb7b86e?w=900&q=85&auto=format&fit=crop', style: 'Luxury',       room: 'Living Room', wide: true },
  { img: 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=500&q=80&auto=format&fit=crop', style: 'Modern',       room: 'Bedroom',     wide: false },
  { img: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=500&q=80&auto=format&fit=crop', style: 'Minimalist',   room: 'Kitchen',     wide: false },
  { img: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=500&q=80&auto=format&fit=crop', style: 'Scandinavian', room: 'Living Room', wide: false },
  { img: 'https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?w=500&q=80&auto=format&fit=crop', style: 'Japandi',      room: 'Bathroom',    wide: false },
]
...
export default function Home() {
  ...
  const G = 'linear-gradient(135deg,#4f7cff,#7c3aed)'

  return (
    <div style={{ fontFamily: "'Inter',-apple-system,BlinkMacSystemFont,system-ui,sans-serif", background: '#fff', color: '#0f172a', overflowX: 'hidden' }}>

      {/* ══ NAV ══ */}
      <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 1000, background: 'rgba(255,255,255,0.95)', backdropFilter: 'blur(20px)', borderBottom: '1px solid #f1f5f9', boxShadow: '0 1px 12px rgba(0,0,0,0.05)' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 28px', height: 66, display: 'flex', alignItems: 'center', gap: 32 }}>

          {/* Logo */}
          <a href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none', flexShrink: 0 }}>
            <div style={{ width: 36, height: 36, borderRadius: 11, background: G, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 900, fontSize: 18, boxShadow: '0 4px 12px rgba(79,124,255,0.4)' }}>R</div>
          ...
          <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
            <a href="/create" className="nav-link" style={{ color: '#4f7cff', fontWeight: 600 }}>Design Studio</a>
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '60px 28px 80px', width: '100%', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'center' }}>
          ...
          <div>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'rgba(79,124,255,0.08)', border: '1px solid rgba(79,124,255,0.2)', borderRadius: 100, padding: '7px 18px', fontSize: 13, fontWeight: 600, color: '#4f7cff', marginBottom: 28 }}>
              <span className="pulse" style={{ width: 6, height: 6, borderRadius: '50%', background: '#4f7cff', display: 'inline-block' }} />
            ...
            <h1 style={{ fontSize: 'clamp(38px,5vw,66px)', fontWeight: 900, lineHeight: 1.07, letterSpacing: '-2.5px', marginBottom: 22 }}>
              Design Your<br />
              <span className="grad">Dream Home</span><br />
              with AI
            </h1>
            ...
            <div style={{ display: 'flex', gap: 14, marginBottom: 52, flexWrap: 'wrap' }}>
              <a href="/create" className="btn-primary" style={{ fontSize: 16, padding: '15px 36px' }}>✦ Design for Free</a>
          ...
          <div style={{ position: 'relative' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
              {/* Large card */}
              <div className="gallery-card" style={{ gridRow: 'span 2', borderRadius: 22, boxShadow: '0 20px 60px rgba(0,0,0,0.15)' }}>
                ...
                <div style={{ position: 'absolute', bottom: 18, left: 16 }}>
                  <div style={{ display: 'inline-block', background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(8px)', border: '1px solid rgba(255,255,255,0.2)', borderRadius: 20, padding: '3px 10px', fontSize: 11, fontWeight: 700, color: 'white', marginBottom: 5 }}>✦ AI</div>
              ...
              {[
                ...
                <div key={item.label} className="gallery-card" style={{ borderRadius: 18, boxShadow: '0 8px 24px rgba(0,0,0,0.1)' }}>
            ...
            {/* Floating badge */}
            <div className="float" style={{ position: 'absolute', bottom: -18, left: -18, background: 'white', borderRadius: 18, padding: '12px 18px', boxShadow: '0 10px 36px rgba(0,0,0,0.12)', display: 'flex', alignItems: 'center', gap: 12, border: '1px solid #f1f5f9' }}>
              <div style={{ width: 40, height: 40, borderRadius: 12, background: G, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18 }}>🤖</div>
              <div>
      ...
      <section id="design-tool" style={{ background: '#f8faff', padding: '96px 28px', borderTop: '1px solid #f1f5f9' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 52 }}>
            <div className="section-label">Quick Design Tool</div>
            <h2 style={{ fontSize: 'clamp(26px,3.5vw,46px)', fontWeight: 900, letterSpacing: '-1.5px', marginBottom: 12 }}>Try AI Design Right Now</h2>
            <p style={{ fontSize: 17, color: '#64748b', maxWidth: 480, margin: '0 auto 8px' }}>Pick a room and style — get an instant AI design concept</p>
            <a href="/create" style={{ fontSize: 14, color: '#4f7cff', fontWeight: 600, textDecoration: 'none' }}>Want more control? Use the Full Design Studio →</a>
          </div>
          ...
          <div style={{ background: 'white', borderRadius: 28, boxShadow: '0 8px 48px rgba(0,0,0,0.08)', border: '1px solid #e8eaf0', overflow: 'hidden' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px' }}>
              ...
              {/* Left */}
              <div style={{ padding: '36px 36px', borderRight: '1px solid #f1f5f9' }}>

                {/* Room */}
                <div style={{ marginBottom: 32 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
                    <div style={{ width: 28, height: 28, borderRadius: '50%', background: G, color: 'white', fontSize: 13, fontWeight: 800, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>1</div>
                    <span style={{ fontSize: 16, fontWeight: 800, color: '#0f172a' }}>Choose Room</span>
                  </div>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 10 }}>
                    {ROOMS.map(r => (
                      <button key={r.name} onClick={() => setRoom(r.name)}
                        className="picker-btn"
                        style={{ borderRadius: 13, border: `2.5px solid ${room === r.name ? '#4f7cff' : '#e8eaf0'}`, boxShadow: room === r.name ? '0 0 0 3px rgba(79,124,255,0.12)' : undefined }}>
                ...
                <div style={{ marginBottom: 32 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
                    <div style={{ width: 28, height: 28, borderRadius: '50%', background: G, color: 'white', fontSize: 13, fontWeight: 800, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>2</div>
                    <span style={{ fontSize: 16, fontWeight: 800, color: '#0f172a' }}>Select Style</span>
                  </div>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 10 }}>
                    {STYLES.map(s => (
                      <button key={s.name} onClick={() => setStyle(s.name)}
                        className="picker-btn"
                        style={{ borderRadius: 12, border: `2.5px solid ${style === s.name ? s.c : '#e8eaf0'}`, transform: style === s.name ? 'scale(1.04)' : 'scale(1)', boxShadow: style === s.name ? `0 0 0 3px ${s.c}20` : undefined }}>
                        <img src={s.img} alt={s.name} style={{ width: '100%', height: 68, objectFit: 'cover', display: 'block' }} />
                ...
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 14 }}>
                    <div style={{ width: 28, height: 28, borderRadius: '50%', background: G, color: 'white', fontSize: 13, fontWeight: 800, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>3</div>
                    <span style={{ fontSize: 16, fontWeight: 800, color: '#0f172a' }}>Describe Your Vision <span style={{ fontSize: 13, color: '#94a3b8', fontWeight: 400 }}>optional</span></span>
                  </div>
                  <textarea
                    className="input-field"
                    value={prompt}
                    onChange={e => setPrompt(e.target.value)}
                    placeholder="e.g. Warm lighting, walnut floors, floor-to-ceiling windows, reading nook, lots of plants..."
                    style={{ minHeight: 100, resize: 'none', lineHeight: 1.7 }}
                  />
                  <p style={{ fontSize: 12, color: '#94a3b8', marginTop: 8 }}>💡 Be specific about colors, materials, and mood for better results</p>
                </div>
              </div>

              {/* Right — summary */}
              <div style={{ padding: '36px 28px', background: '#fafbff', display: 'flex', flexDirection: 'column' }}>
                <h3 style={{ fontSize: 16, fontWeight: 800, color: '#0f172a', marginBottom: 20 }}>Your Design</h3>

                {/* Style preview image */}
                <div style={{ borderRadius: 14, overflow: 'hidden', marginBottom: 20, boxShadow: '0 6px 20px rgba(0,0,0,0.1)', position: 'relative' }}>
                  <img src={STYLES.find(s => s.name === style)?.img} alt={style} style={{ width: '100%', height: 150, objectFit: 'cover', display: 'block' }} />
                ...
                <div style={{ background: 'white', borderRadius: 12, padding: '14px 16px', marginBottom: 20, border: '1px solid #e8eaf0' }}>
                  {[{ l: 'Room', v: room }, { l: 'Style', v: style }, { l: 'AI', v: 'Claude AI' }].map(({ l, v }) => (
                ...
                {error && (
                  <div style={{ background: '#fef2f2', border: '1px solid #fecaca', borderRadius: 10, padding: '11px 14px', fontSize: 13, color: '#dc2626', marginBottom: 14 }}>⚠️ {error}</div>
                )}

                <button onClick={generate} disabled={loading} className="btn-primary"
                  style={{ width: '100%', padding: '16px', fontSize: 15, marginTop: 'auto', opacity: loading ? 0.7 : 1, cursor: loading ? 'not-allowed' : 'pointer', borderRadius: 14, justifyContent: 'center' }}>
                  {loading
                ...
                <div style={{ marginTop: 18, paddingTop: 18, borderTop: '1px solid #f1f5f9' }}>
                  <a href="/create" className="btn-secondary" style={{ display: 'flex', width: '100%', justifyContent: 'center', fontSize: 13, padding: '10px 14px', borderRadius: 10 }}>
                    🔧 Full Studio — upload photo, set preferences
                  </a>
                </div>
              </div>
            </div>
        ...
        <section id="result" style={{ background: 'white', padding: '80px 28px', borderTop: '1px solid #f1f5f9' }}>
          <div style={{ maxWidth: 1100, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 36 }}>
              ...
              <h2 style={{ fontSize: 32, fontWeight: 900, letterSpacing: '-1px', color: '#0f172a' }}>
                {result.design?.title || `${style} ${room}`}
              </h2>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: 24, alignItems: 'start' }}>
              <div>
                <div style={{ borderRadius: 22, overflow: 'hidden', boxShadow: '0 20px 60px rgba(0,0,0,0.12)', marginBottom: 16, position: 'relative' }}>
                ...
                <div style={{ display: 'flex', gap: 10, marginBottom: 16 }}>
                  <a href={result.image} target="_blank" rel="noopener" className="btn-primary" style={{ flex: 1, justifyContent: 'center', textDecoration: 'none' }}>⬇ Open Full Image</a>
                  <button onClick={() => { setResult(null); window.scrollTo({ top: 0, behavior: 'smooth' }) }} className="btn-secondary">🔄 New Design</button>
                  <a href="/create" className="btn-secondary" style={{ textDecoration: 'none' }}>🔧 Full Studio</a>
                </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                <div style={{ background: 'white', border: '1px solid #e8eaf0', borderRadius: 16, padding: 20 }}>
                  <h3 style={{ fontSize: 14, fontWeight: 800, color: '#0f172a', margin: '0 0 16px' }}>Details</h3>
                ...
                <a href="/create" className="btn-primary" style={{ justifyContent: 'center', textDecoration: 'none' }}>🔧 Full Studio</a>
                <div style={{ background: '#fffbeb', border: '1px solid #fde68a', borderRadius: 12, padding: 14 }}>
                  <p style={{ fontSize: 12, color: '#92400e', lineHeight: 1.7, margin: 0 }}>💡 Upload your actual room photo in the <a href="/create" style={{ color: '#4f7cff', fontWeight: 700 }}>Full Studio</a> for more accurate results.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="features" style={{ background: 'white', padding: '96px 28px' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 20, textAlign: 'left' }}>
            {[
              { icon: '📸', title: 'Upload Any Room', desc: 'Take a photo of your room. AI analyzes the space, lighting, and layout instantly.' },
              { icon: '🎨', title: '8 Design Styles', desc: 'Modern, Luxury, Scandinavian, Japandi, Industrial, Bohemian — each with precision AI prompts.' },
              { icon: '⚡', title: 'Results in 8 Seconds', desc: 'Photorealistic AI-generated designs powered by Claude AI + Unsplash imagery.' },
              { icon: '💬', title: 'AI Design Consultant', desc: 'Get expert advice on colors, furniture, layout, and lighting from Claude AI.' },
              { icon: '🛋️', title: 'Furniture Preservation', desc: 'Upload your existing furniture and AI incorporates it into the new design.' },
              { icon: '📐', title: '4-Step Guided Process', desc: 'The Full Studio walks you through room setup, style, preferences, then generates.' },
            ].map((f, i) => (
      ...
      <section id="styles" style={{ background: '#f8faff', padding: '96px 28px' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 17, color: '#64748b', marginBottom: 48 }}>Click any style to use it — or go to the Full Studio for all 10</p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 16 }}>
            {STYLES.map(s => (
              <div key={s.name} className="gallery-card" onClick={() => { setStyle(s.name); document.getElementById('design-tool')?.scrollIntoView({ behavior: 'smooth' }) }}
                style={{ aspectRatio: '4/3', borderRadius: 18, boxShadow: '0 4px 16px rgba(0,0,0,0.08)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 16, textAlign: 'left' }}>
            {GALLERY.map((g, i) => (
              <div key={i} className="gallery-card"
                onClick={() => { setStyle(g.style); document.getElementById('design-tool')?.scrollIntoView({ behavior: 'smooth' }) }}
                style={{ gridColumn: g.wide ? 'span 2' : 'span 1', aspectRatio: g.wide ? '16/9' : '4/3', borderRadius: 20, boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
                <img src={g.img} alt={`${g.style} ${g.room}`} style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
                <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to top,rgba(0,0,0,0.65),transparent 50%)' }} />
                <div style={{ position: 'absolute', bottom: 18, left: 18 }}>
                  <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.6)', margin: '0 0 4px', textTransform: 'uppercase', letterSpacing: '0.8px' }}>{g.room}</p>
      ...
      <section id="pricing" style={{ background: '#f8faff', padding: '96px 28px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 24, alignItems: 'center' }}>
            {[
              { name: 'Free',   price: '$0',  features: ['3 AI designs/month','All 8 styles','Color palettes & tips','AI design concepts'], cta: 'Start Free', href: '/create', featured: false },
              { name: 'Pro',    price: '$19', features: ['Unlimited AI designs','Full Design Studio','Upload room photos','Furniture upload','Unlimited AI consultant','Commercial rights'], cta: 'Start Pro', href: '/create', featured: true },
              { name: 'Studio', price: '$49', features: ['Everything in Pro','5 team members','API access','White-label exports','Custom presets','Priority support'], cta: 'Contact Sales', href: '/create', featured: false },
            ].map(p => (
              <div key={p.name} className={`price-card${p.featured ? ' featured' : ''}`}
                style={{ position: 'relative', transform: p.featured ? 'scale(1.05)' : 'scale(1)' }}>
                {p.featured && <div style={{ position: 'absolute', top: -14, left: '50%', transform: 'translateX(-50%)', background: G, color: 'white', fontSize: 11, fontWeight: 800, padding: '5px 20px', borderRadius: 100, whiteSpace: 'nowrap' }}>MOST POPULAR</div>}
                ...
                <div style={{ marginBottom: 28 }}>
                  ...
                  <span style={{ fontSize: 15, color: p.featured ? 'rgba(255,255,255,0.5)' : '#94a3b8' }}>/mo</span>
                </div>
                <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 32px', flex: 1, display: 'flex', flexDirection: 'column', gap: 12, textAlign: 'left' }}>
                  {p.features.map(f => (
                    <li key={f} style={{ display: 'flex', alignItems: 'flex-start', gap: 10, fontSize: 14, color: p.featured ? 'rgba(255,255,255,0.75)' : '#374151', lineHeight: 1.4 }}>
                      <span style={{ color: p.featured ? '#818cf8' : '#16a34a', fontWeight: 800, flexShrink: 0 }}>✓</span>{f}
                    </li>
                  ))}
                </ul>
                <a href={p.href} className={p.featured ? 'btn-primary' : 'btn-secondary'}
                  style={{ display: 'block', textAlign: 'center', padding: 14, borderRadius: 14, fontWeight: 800, fontSize: 15, textDecoration: 'none' }}>{p.cta}</a>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ background: 'linear-gradient(135deg,#0f172a,#1e1b4b)', padding: '96px 28px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 680, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ fontSize: 17, color: 'rgba(255,255,255,0.5)', marginBottom: 40, lineHeight: 1.7 }}>Join 10,000+ homeowners using RoomGenie AI.</p>
          <a href="/create" className="btn-primary" style={{ fontSize: 17, padding: '18px 48px' }}>✦ Open Design Studio</a>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 48, marginBottom: 48, paddingBottom: 48, borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
            <div>
              <a href="/" style={{ display: 'flex', alignItems: 'center', gap: 9, textDecoration: 'none', marginBottom: 16 }}>
                <div style={{ width: 34, height: 34, borderRadius: 10, background: G, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 900, fontSize: 16 }}>R</div>
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                {['𝕏','in','ig'].map(s => <a key={s} href="#" className="social-icon">{s}</a>)}
              </div>
            </div>
            {[
              { title: 'Product',  links: [['Design Studio','/create'],['Quick Tool','#design-tool'],['Pricing','/pricing'],['Gallery','#gallery']] },
              { title: 'Styles',   links: [['Modern','#styles'],['Luxury','#styles'],['Scandinavian','#styles'],['Bohemian','#styles']] },
