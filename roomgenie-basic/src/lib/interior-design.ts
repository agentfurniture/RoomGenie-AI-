...
export const DESIGN_STYLES: Record<DesignStyle, StyleDefinition> = {
  ...
  Luxury: {
    ...
    materials: ['velvet','marble','brass','gold','linen'],
  ...
  Scandinavian: {
    ...
    materials: ['pine','oak','linen','wool','cotton'],
    floorMaterial: 'hardwood', wallFinish: 'paint',
  ...
  Classic: {
    ...
    materials: ['mahogany','velvet','brass','wool','linen'],
  ...
  Coastal: {
    ...
    materials: ['linen','cotton','rattan','teak','wicker'],
